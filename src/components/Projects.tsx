  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive logistics application built to monitor real-time trailer metrics and fuel data directly on the yard.",
      imgSrc: "/yardwalk.webp",
    ...
    },
    {
      ...
      description:
        "A dedicated fleet management tool designed to track trailer operations, operational hours, and critical fuel metrics. Streamlines field auditing workflows with a highly responsive utility card interface and direct data recording.",
      imgSrc: "trailerfuel.webp",
    ...
    },
    {
      ...
      description:
        "A custom, responsive wedding invitation web application built with HTML,CSS and JS. Built from scratch to deliver an interactive guest experience with custom event details, elegant mobile-first card layouts, and dynamic UI components.",
      imgSrc: "Wedding-invite.webp",
    ...
    },
    {
      ...
      description:
        "A media streaming dashboard featuring robust routing configurations, live credential validation, and dynamic grids.",
      imgSrc: "netflixclone.webp",
